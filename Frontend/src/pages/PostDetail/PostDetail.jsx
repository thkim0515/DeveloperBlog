...
export const PostDetail = () => {
  ...
  useEffect(() => {
    axios.post("/contents/view", { _id: post._id }).catch(error => console.error("Error:", error));
  }, [post._id]);
    ...
    <>
      ...
      {detailContent.imagePath && (
        <S.SContainer>
          ...
          <S.SLikeBackButton>
            <LikeButton content_id={detailContent._id} user_id={userId} boardSortation="contents" />
